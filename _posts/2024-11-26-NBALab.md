...
The first comparison I tried was Player Weight as the independent and Pts as the dependent. Going into this specific test, I did not expect a high correlation between the differing heights of NBA players. There are stars from all different heights, and therefore, we should expect not to see a super-defined slope. 

![Playerweight / Pts](assets/img/playerweight:pts.png)
...
![Playerheight / reb](assets/img/height:reb.png)

![Playerweight / ast](assets/img/height:ast.png)
