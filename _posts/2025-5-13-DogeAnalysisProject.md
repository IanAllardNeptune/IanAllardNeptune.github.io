...
In addition to the removal of several key contracts, multiple articles and papers have exposed inaccuracies in the false claims the DOGE.gov website provides. The main page of the savings section sums up all of the contracts that they claimed to have saved. The main goal of my project is to detect inaccuracies across the website in what they claimed to have saved. There are a couple places that I am analyzing to compare the data they present and what the reality is. The first place is [the API]([https://www.kaggle.com/datasets/justinas/nba-players-data/data](https://api.doge.gov/docs) that they provide.
